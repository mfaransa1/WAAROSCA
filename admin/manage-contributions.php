...
<div id="layoutSidenav_content" id="content-wrapper">
                <main>
                    <div class="container-fluid px-4">
                            ...
                            <a href="#"  align="right" class="btn btn-sm btn-danger">Approved Contributions Page</a>
                              ...
                              <table id="dataTable" class="table table-bordered"   width="100%" cellspacing="0">
                                    ...
                                    $sql = "SELECT payments.*, users.fname, users.lname from payments inner join users on users.id=payments.userid where pay_type=:pay_type and payments.status=0";
