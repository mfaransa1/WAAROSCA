...
<?php include('includes/sidebar.php');?>
            ...
            <div id="layoutSidenav_content">
                <main>
					...
					<h1 class="mt-4">Single Member Detail</h1>
...
<ul class="form-style-1">
	...
	<li>        <label>Email</label>
        <input type="text" name="refno"  required class="form-control" value="<?php echo htmlentities($result->email); ?>" />
    </li>

                                                    <li>        <label>Contact</label>
        <input type="text" name="refno"  required class="form-control" value="<?php echo htmlentities($result->contact); ?>" />
    </li>
