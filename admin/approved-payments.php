                    ...
                    <div class="container-fluid px-4">
                            ...
                            <a href="" id="create_new" align="right" class="btn btn-sm btn-primary">Approved Payments</a>
                              ...
                              <table id="dataTable" class="table table-bordered"   width="100%" cellspacing="0">
                                   ...
                                   <small> , Balance=<?php echo htmlentities($result->balance); ?>
                                </small><span style="color:red; font-size:15px;">shillings</span>, Type of payment: <span style="color:blue; font-size:15px;"><?php echo htmlentities($result->pay_type); ?></span></p> </td>
