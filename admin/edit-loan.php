...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE `loans` SET refno=:refno,amount=:amount,due_date=:due_date WHERE id=:id ";
        ...
        echo "<script>alert('Loan updated successfully');document.location = 'manage-loans.php';</script>";
    }}
?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <label for="inputPassword">Due Date <span class="required">months</span></label>
                                                    </div>
                                                </div></div>
