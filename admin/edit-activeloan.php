...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
     ...
     //   $amount= $_POST['amount'];        
        ...
        echo "<script>alert('Loan updated successfully');document.location = 'active-loans.php';</script>";
    }}
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Update Active Loan Details</h3></div>
                                    <div class="card-body">
