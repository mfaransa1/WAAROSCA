...
$userid=$_POST['userid'];
    $status= 0;
    $query=mysqli_query($con, "INSERT INTO savings (userid,amount,refno,status) VALUES('$userid','$amount','$refno','$status')");
                ...
                <main>
                  ...
                  <?php }} ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" name="amount" min="100" max="100000" class="form-control text-left"  step="0.0" >
