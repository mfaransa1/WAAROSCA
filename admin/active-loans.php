...
<div id="layoutSidenav_content" id="content-wrapper">
                    ...
                    <div class="container-fluid px-4">
                            ...
                            <a href="" id="create_new" align="right" class="btn btn-sm btn-primary">Active Loans</a>
                              ...
                              <table id="dataTable" class="table table-bordered"   width="100%" cellspacing="0">
                                    ...
                                    $sql = "SELECT loans.*, users.fname, users.lname from loans INNER JOIN users on users.id=loans.userid and loans.`status`=0";
                                    ...
                                    <td>
                                        <p><span style="color:green; font-size:15px;">Ksh.<?php echo htmlentities($result->amount); ?> Due Date </span>
    ...
    <td>
    <a href="edit-activeloan.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;        
    <a href="active-loans.php?uaid=<?php echo $result->id; ?>"
                                                           onclick="return confirm('Do you want to clear this loan?');">Clear</a>
                                </td>
