...
<?php include('includes/sidebar.php');?>
            ...
            <div id="layoutSidenav_content" id="content-wrapper">
                <main>
                    <div class="container-fluid px-4">
                            ...
                            <a href="add-contribution.php" id="create_new" align="right" class="btn btn-sm btn-primary"> Add Contribution</a>
                              ...
                              <table id="dataTable" class="table table-bordered"   width="100%" cellspacing="0">
                                    ...
                                    <thead>
                                        <tr>
                                        <th>ID</th>
                                            <th>Amount <span style="color:red; font-size:15px;">Ksh</span></th>                                          
                                    ...
                                    $status = 0;
                                    $sql = "SELECT payments.* FROM payments WHERE payments.userid=:uid AND payments.status=:status";
                                    $query = $dbh->prepare($sql);
	...
	<td>
	<a href="edit-cont.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a></td>
                                        </tr>
                                        <?php $cnt = $cnt + 1;
                                            }
                                        } ?>
