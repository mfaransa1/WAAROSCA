            ...
            <div id="layoutSidenav_content" id="content-wrapper">
                <main>
                    <div class="container-fluid px-4">
                            ...
                            <a href="" id="create_new" align="right" class="btn btn-sm btn-primary">Cleared Loans</a>
...
if ($query->rowCount() > 0) {
    foreach ($results as $result) { ?>
                                        ...
                                        <tr>
                                        <td><?php echo htmlentities($cnt); ?></td>  <td><?php echo htmlentities($result->created_date); ?></td>
                                    <td>
                                        <p><span style="color:green; font-size:15px;"><?php echo htmlentities($result->amount); ?> Shillings,</span>
                                   <small> Cleared Date
                                <span style="color:red; font-size:15px;"> <?php echo htmlentities($result->due_date); ?></span> </small> </p> </td>
